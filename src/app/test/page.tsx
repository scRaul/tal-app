// import CourseContent from "@/components/studio/EditModules";
// import CourseForm from "@/components/studio/EditCourseForm";
...
//       <h1 className="text-2xl md:text-4xl  my-2">{course.title}</h1>
